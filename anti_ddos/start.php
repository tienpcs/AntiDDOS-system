<?php 
	...
	if(isset($_SESSION['standby'])){
		...
		<div class="loading" style="margin-top: 11%;">
		  ...
		  <div class="loading__msg"><center><b style="font-size: 22px;">ANTI DDOS</a> Đang Kiểm Tra</b><br><br>Xin chào, đừng lo lắng, đây là một xác minh bảo mật đơn giản, bạn sẽ thấy điều này một lần duy nhất<br> trang web của bạn sẽ sớm xuất hiện</center></div>
		</div>
